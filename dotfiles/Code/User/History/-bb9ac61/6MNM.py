...
pgconn = psycopg2.connect(dbname="flo_stage_us", user="flo",
                          password="pvHZ&5y3A&nT8TQN", host="172.20.20.90")
pgcur = pgconn.cursor()
...
rsconn = redshift_connector.connect(host=rs_host, database=rs_database,
