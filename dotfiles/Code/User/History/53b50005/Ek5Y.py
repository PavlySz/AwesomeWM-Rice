...
import boto3
import redshift_connector~from botocore.exceptions import ClientError
...
# If this throws any errors, you should go back to the export method
...
# ! Look up where to use PGPASSWORD
...
sql_queries_to_be_executed = ["booking"]
