	...
	s.central_panel = awful.popup({
		...
		placement = function(w)
			awful.placement.bottom(w, {
				--MEADD Changed because I moved the wibox to the top
		...
		widget = {
			{
				...
				},
				{
					...
					shape = helpers.ui.prrect(beautiful.border_radius * 10, true, true, false, false),
			...
			bg = beautiful.widget_bg,
			shape = helpers.ui.rrect(beautiful.border_radius * 10),
			widget = wibox.container.background,
		},
	})
