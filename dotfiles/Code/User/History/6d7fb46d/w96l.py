...
# ! Okay, so..
# ! The booking report went into s3-data-layer/prod/reports
# ! The Flight report went into s3-data-layer/reports
# ! The expected behaviour is to put both into s3-data-layer/stage/reports
# ! All source tables in prod/source_tables were modified today at 7am. I was not even awake at 7
# ! Maybe "modified" is not to be taken as the metric of where I put things?
# ! FUCK
# ! Change the unloading location in `flight_report.sql` and `booking_report.sql`
# ! Depending on whether the `prod` or `stage` script is ran.
# Is that fucking SQL injection?
