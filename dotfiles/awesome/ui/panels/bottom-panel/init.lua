...
return function(s)
	...
	s.bottom_panel = awful.popup({
		...
		placement = function(c)
			-- MEADD I changes this. Was bottom.
			-- TODO fix the top margin of the clients so that they don't overlap with wibox
	...
	s.bottom_panel:struts({
		-- MEADD Changed from bottom to top
		-- because I moved the panel to the top
