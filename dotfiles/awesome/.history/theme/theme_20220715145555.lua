...
--- Corner Radius
theme.border_radius = 25   --MEADD Was 12
...
--- Gaps
-- MEADD Changed from 2 to 10 cause gaps
-- Prayge I find a similar setting for paddings
...
theme.mstab_bar_padding = dpi(100)
theme.mstab_border_radius = dpi(60)
