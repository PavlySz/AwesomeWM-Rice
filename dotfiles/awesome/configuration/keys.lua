...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ mod }, "b", function()
		...
		awful.spawn("brave")
	end, { description = "open Brave web browser", group = "app" }),

	-- Firefox
	awful.key({ mod }, "f", function()
		awful.spawn("firefox")
	end, { description = "open Firefox web browser", group = "app" }),

	-- Toggle Keyboard layout
	awful.key({ alt }, " ", function()
		os.execute("~/.local/bin/toggle_keyboard")
	end, { description = "Toggle keyboard layout", group = "app" }),
